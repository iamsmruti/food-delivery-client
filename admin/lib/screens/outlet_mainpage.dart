...
class outlet_mainpage extends StatefulWidget {
  const outlet_mainpage({super.key});

  @override
  State<outlet_mainpage> createState() => _outlet_mainpageState();
}

class _outlet_mainpageState extends State<outlet_mainpage> {
